  ...
  return (
    ...
    >
      <div className=" fixed w-full inset-0 z-50 overflow-hidden flex justify-center items-center bg-black bg-opacity-70 	">
        <div className=" border border-blue-500 modal-container bg-white w-11/12 max-w-sm sm:w-10/12 md:max-w-none md:w-9/12 lg:w-1/2 mx-auto rounded-lg shadow-lg z-50 overflow-y-auto">
